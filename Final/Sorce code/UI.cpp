...
bool LoginWindow(){
    ...
    bool isLoginCompleted = false; // CompletedLogin flag
    ...
    if(Ans != 'Y'){
        ...
        std::cout << "Mail Server address: ";
        std::getline(std::cin, UserMailServer);

        std::cout << "Port STMP: ";
        std::cin >> UserPortSMTP;
        std::cin.ignore();

        std::cout << "Port POP3: ";
        std::cin >> UserPortPop3;
        std::cin.ignore();        

        std::cout << "Autoload(s): ";
        std::cin >> UserAutoload;
        std::cin.ignore();
...
void downloadMail(){
    POP3Client local_client(UserMailServer, UserPortPop3);
